...
agentgraph auth slack [--method oauth|browser] [--add] [--account <account-id>] # chooses auth method, then asks whether the user administers the target workspace and shows role-specific OAuth setup
