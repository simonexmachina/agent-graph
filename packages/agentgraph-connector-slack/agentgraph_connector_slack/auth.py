...
def _authorization_instructions() -> str:
    return (
        ...
        "      creates a local, queryable graph of conversations I can already\n"
        "      access so my AI tools can search my work context. It requests read\n"
        "      access to public channels, private channels, DMs, group DMs, and\n"
        "      member profiles; email access is optional. More information:\n"
