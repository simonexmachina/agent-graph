...
def _authorization_instructions() -> str:
    return (
        ...
        "    For Message for your Slack Admin, you can use:\n\n"
        "      Hi, I'd like approval to connect AgentGraph to Slack. AgentGraph "
        "creates a local, queryable graph of conversations I can already access "
        "so my AI tools can search my work context. It requests read access to "
        "public channels, private channels, DMs, group DMs, and member profiles; "
        "email access is optional. More information: "
        "https://agentgraph.simonwa.de/\n\n"
