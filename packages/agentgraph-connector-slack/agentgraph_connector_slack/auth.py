...
def _oauth_setup_instructions() -> str:
    ...
    return (
        ...
        f"     {manifest_path}\n"
        "  2. If Slack blocks installation, click Request approval on the Slack\n"
        "     authorization page, add context for the admin, and submit it.\n"
        "     A Workspace Owner or app manager reviews it in Slack under\n"
        "     Admin > Apps and workflows > Requests, including optional scopes.\n"
        ...
        "\n"
        "After approval, rerun this command. If Request approval is unavailable,\n"
        "ask a Workspace Owner; the workspace may not allow member requests.\n"
