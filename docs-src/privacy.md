...
AgentGraph is an open-source application that you install and run locally on your own computer. It indexes content from connected sources into a local database and makes that data searchable via a CLI, web viewer, and MCP server.

## Data collection and storage

- Indexed content is stored in a local SQLite database by default.
