"""Seed the isolated, fictional Atlas launch-demo graph."""
...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument(
        ...
        required=True,
        type=Path,
        help="Explicit non-default AgentGraph config directory for the demo database",
    )
    parser.add_argument(
        "--reset",
        action="store_true",
        help="Replace only agentgraph.db and its SQLite sidecars in the selected demo directory",
    )
